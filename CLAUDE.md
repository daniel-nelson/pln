...
- `bash tests/assurance.sh` — `bin/pln-assurance`: semantic R1/R2/R3 classification where numeric size only escalates, capped broad/specialist/adversarial rosters with truthful peer substitution, and exact candidate fingerprints over tree, command set, and relevant environment.
