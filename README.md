...
| Unattended liveness | native completion notifications keep the coordinator active | five-minute visible heartbeat + mailbox reconciliation + manifest finish gate; native goal for explicit across-turn requests when available |
