...
1. Read `CLAUDE.md` and `AGENTS.md` at the project root and any nested ones the task touches. Surface any mandated rules (e.g., "invoke psychic-skill first") and persistent TODOs (e.g., a tenant-scoping reminder) at the top of the eventual `PLAN.md`.
