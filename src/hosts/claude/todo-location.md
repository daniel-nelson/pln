...
A named file is left exactly as it is. The to-do-list root may be derived from the directory that contains it; the file itself is never appended to, rewritten, or moved.
