...
**What the run still owes the user: one short list, printed before implementation starts. It stops nothing.** Three things reach it, each recorded and each carried to where the user will actually read it:
